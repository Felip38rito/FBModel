#
#  Be sure to run `pod spec lint FBModel.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Felipe Correia Brito"
  # spec.authors            = { "Felipe Correia Brito" => "felipe.correia.wd@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Felipe Correia Brito"
